...
//            taskDateIcon.heightAnchor.constraint(equalToConstant: 36),
            ...
            taskDeadlineLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -5),
            taskDeadlineLabel.topAnchor.constraint(equalTo: taskRewardLabel.bottomAnchor),
...
//            taskDeadlineLabel.widthAnchor.constraint(equalToConstant: 80),
            ...
            taskNameLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 10),
//            taskNameLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -10),
            ...
            taskDateLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 10),
...
//            taskRewardLabel.leadingAnchor.constraint(equalTo: taskDeadlineLabel.trailingAnchor, constant: 10),
            ...
            taskRewardLabel.topAnchor.constraint(equalTo: taskDateLabel.bottomAnchor),
//            taskRewardLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -5),
    ...
    func configure(date: String, taskName: String, reward: String, deadline: String) {
